...
def has_kitty_gene(dna):
    ...
    """
    "*** YOUR CODE HERE ***"
    kitty_gene = link('C', link('A', link('T', link('C', link('A', link('T'))))))
    return has_sublist(dna, kitty_gene)
...
def count_change(amount, denominations):
    ...
    if amount == first(denominations):
        ...
        return count_change(amount, rest(denominations))
    else:
